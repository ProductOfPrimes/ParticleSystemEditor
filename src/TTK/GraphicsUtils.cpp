...
void TTK::Graphics::SetCameraMode2D(int x, int y, int windowWidth, int windowHeight)
{
	...
	glOrtho(0.0f, (float)windowWidth, 0.0f, (float)windowHeight, 0.001f, 10000.0f);
 ...
 void TTK::Graphics::SetCameraMode3D(int x, int y, int windowWidth, int windowHeight)
{
	...
	glViewport(x, y, windowWidth, windowHeight);
	gluPerspective(30.0f, (float)windowWidth / (float)windowHeight, 0.001f, 10000.0f);
...
void TTK::Graphics::DrawGrid(float scale)
{
	glPushMatrix();
